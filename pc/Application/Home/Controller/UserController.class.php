...
class UserController extends HomeController
{
	...
	public function uppassword_qqbtc($oldpassword="", $newpassword="",$repassword="")
	{
		if (!userid()) {
			$this->error('请先登录！');
		}
	...
	public function uppaypassword_qqbtc($oldpaypassword, $newpaypassword, $repaypassword)
	{
		if (!userid()) {
			$this->error('请先登录！');
		}
	...
	public function upmoble_qqbtc($moble_new="", $moble_verify_new="")
	{
		if (!userid()) {
			$this->error('您没有登录请先登录！');
		}
	...
	public function upgoods_qqbtc($name="", $truename="", $idcard="", $moble="", $addr="", $paypassword="",$prov="",$city="")
	{
		if (!userid()) {
			redirect('/#login');
		}
